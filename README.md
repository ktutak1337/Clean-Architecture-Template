...
[![NuGet Package](https://img.shields.io/badge/NuGet-1.0.36-blue.svg)](https://www.nuget.org/packages/Clean.Architecture.Template)
...
``` csharp
~$ dotnet new --install Clean.Architecture.Template::1.0.36
```
...
| Add Shared project as optional | todo | - |
| API versioning | todo | - |
