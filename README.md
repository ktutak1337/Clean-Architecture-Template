...
[![NuGet Package](https://img.shields.io/badge/NuGet-1.0.31-blue.svg)](https://www.nuget.org/packages/Clean.Architecture.Template)
...
``` csharp
~$ dotnet new --install Clean.Architecture.Template::1.0.31
```
